...
export default function TypographyPage() {
  return (
    <>
      <Head>
        <title>Tailwind Typography Test</title>
      </Head>
      <div className="relative w-full px-6 py-12 ring-1 ring-gray-900/5 md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-16 lg:pb-28">
